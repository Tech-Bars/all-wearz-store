...
const Populardeals:React.FC = () => {
  return (
    <div className="w-full flex gap-5 px-5 pb-20">
           <h1 className=" flex items-center justify-center   text-3xl bg-[#1F2937]/70 font-semibold absolute w-[311px] h-[68px] left-[1058px] top-[37rem]">Popular deals</h1>
