...
const Newarrivals:React.FC = () => {
  return (
    <div className="my-4 p-5 h-[30rem] md:h-[368px] lg:h-[368px] flex flex-col md:flex-row lg:flex-row w-full gap-5 justify-center bg-[#D9D9D9] items-center font-sora rounded-md m-auto" data-aos="zoom-in-up">
      ...
      <div className='w-1/2 h-full'>
          <img src={shirt} alt="" className="w-full h-full lg:w-[80%] md:w-[80%] m-auto" />
      </div>
    </div>
  )
}
