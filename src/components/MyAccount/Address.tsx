    ...
    return (
        <div className="bg-gray-50 shadow-lg rounded-md ">
            <div className="flex justify-between items-center px-1 border-b ">
                <h1 className="text-xl p-2 font-sora font-semibold ">
                    Address
                </h1>
                <img
                    src={Edit}
                    alt="Edit Icon"
                    className="cursor-pointer w-8 h-8 p-1 transition-all duration-200 ease-in-out hover:scale-105"
                />
            </div>
            <div className="p-2 flex flex-col">
                ...
                <span>
                    <h2 className="text-sm font-sora  text-black ">
                        202 opposite university of maiduguri
                    </h2>
                </span>
                <span>
                    <h2 className="text-sm font-sora  text-black ">
