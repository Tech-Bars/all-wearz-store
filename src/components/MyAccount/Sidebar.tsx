  ...
  return (
    <div className="border bg-gray-50 flex flex-col justify-between  w-[30%] ">
       ...
       <div className="flex flex-col ">
        <NavLink className={({isActive}:{isActive:boolean}): string => {return isActive ? isActiveLink : ""}} to="."> 
        ...
        <div>
          <span className="text-base flex justify-center items-center border-t-2 cursor-pointer text-primary p-2 transition-all duration-300 delay-75 ease-in-out hover:bg-secondary hover:font-semibold">LOGOUT</span>
        </div>
       </div>
